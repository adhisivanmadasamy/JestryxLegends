	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float temp_output_628_0_g1 = pow( abs( saturate( dotResult625_g1 ) ) , _Hardness );
...
ASEEND*/
//CHKSM=8F8D30E47B3F40704E8E3A0861887E08A59B63C1